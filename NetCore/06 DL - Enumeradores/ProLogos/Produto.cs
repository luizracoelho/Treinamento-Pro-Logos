...
namespace ProLogos
{
    public class Produto : BaseDomain
    {
        ...
        public Produto(string codigo, string descricao, decimal saldoEstoque, decimal valorCompra, decimal valorVenda, long marcaId, long grupoProdutoId, TipoProduto tipoProduto)
        {
            Codigo = codigo;
            Descricao = descricao;
        ...
        public Produto(string codigo, string descricao, decimal saldoEstoque, decimal valorCompra, decimal valorVenda, long marcaId, long grupoProdutoId, TipoProduto tipoProduto, bool ativo)
            : this(codigo, descricao, saldoEstoque, valorCompra, valorVenda, marcaId, grupoProdutoId, tipoProduto)
        {
            Ativo = ativo;
        }
        #endregion
